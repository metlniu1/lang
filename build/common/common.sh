...
Diy_all() {
DIY_GET_COMMON_SH
echo -e "\nsrc-git 279437541 https://github.com/279437541/openwrt-package;$REPO_BRANCH" >> feeds.conf.default
...
mv -f feeds/279437541/luci-app-oscam feeds/luci/applications
mv -f feeds/279437541/oscam feeds/packages/net
