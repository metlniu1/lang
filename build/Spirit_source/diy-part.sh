...
echo "大灰狼 Compiled in $(TZ=UTC-8 date "+%Y.%m.%d")" > package/base-files/files/etc/openwrt_gxqm     # 增加个性名字281677160

sed -i "/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-DHL'" $ZZZ                       # 修改主机名称为OpenWrt-123
