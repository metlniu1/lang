...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-DaHuiLang'" $ZZZ       # 修改主机名称为OpenWrt-123

sed -i "s/OpenWrt /大灰狼 build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ        # 增加自己个性名称281677160
